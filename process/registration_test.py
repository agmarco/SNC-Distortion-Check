...
from process.registration import build_f, rigidly_register
...
class TestRegistrationPerfectMatch:
    ...
    def test_big_translation(self):
        self.assert_5x5x5_match([4.4, -2.3, 1.3, 0, 0, 0])

    def test_rotation(self):
        self.assert_5x5x5_match([0, 0, 0, pi/180*2, -pi/180*1, pi/180*2])

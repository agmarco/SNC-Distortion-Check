...
20. Wait a few seconds until the data is done processing.
...
42. Submit the form and wait a few minutes until the data is finished processing.
...
48. Wait a few seconds until the data is finished processing.
